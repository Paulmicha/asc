# Agents of Redirection

## Donella Meadows, Alexandre Monnin, Pierre Lévy

[https://chatgpt.com/share/6a70d5bd-a5b4-83e9-b9ae-6573c56b05a3](https://chatgpt.com/share/6a70d5bd-a5b4-83e9-b9ae-6573c56b05a3)

I think there is a remarkably coherent trajectory from Monnin's 2013 thesis to his current work. What has changed is not the direction of his thought, but its center of gravity. The philosophy of the Web has progressively become a philosophy of ecological limits and of the transformation—not merely the critique—of technical systems.
...
> "What kinds of worlds does the Web make possible?"

This is where his collaborations with Diego Landivar and Emmanuel Bonnet become central.

The object of study is no longer digital technology alone.
...
Redirection starts from another premise:

> Certain technological trajectories cannot be sustained and therefore must eventually be abandoned, transformed or dismantled.

This is a very different intervention point.

Instead of optimizing systems,

one asks

> Which systems should continue existing at all?
...
Computation feels immaterial.

Logistics feels invisible.

Cloud computing feels weightless.

The technology functions almost like ritual magic.
...
the Web hides infrastructure.

In 2026:

all industrial technologies hide infrastructure.

In 2013:

digital objects appear autonomous.

In 2026:

technological systems appear autonomous.

In 2013:

hyperlinks conceal maintenance work.

In 2026:

global logistics conceals planetary extraction.

The underlying philosophical gesture is almost identical:
...
| Meadows | Monnin |
| ----- | ----- |
| feedback loops | attachments |
| resilience | maintenance |
| leverage points | redirection |
| system purpose | ecological compatibility |
| paradigms | technological enchantment |
| delays | geological time |

Where Meadows remains largely cybernetic,
...
The two projects operate at almost opposite levels.

**IEML** attempts to formalize semantic relations, making collective intelligence computable through explicit semantic structures.

**Monnin** increasingly analyzes the material and ecological conditions that make those semantic systems possible—and sometimes impossible to sustain.
