...
| [22-next-steps-like-env.md](2026/09/22-next-steps-like-env.md) | Next-steps lookup matches `env.yml`. This checkout: `NEXT_STEPS.core.md` and `NEXT_STEPS.agent.core.md` |
...
| [19-lazy-opt-inc-remaining-core-waves.md](2026/09/19-lazy-opt-inc-remaining-core-waves.md) | After fs+db+yaml. Next leftover: Wave C `make.inc.sh` |
