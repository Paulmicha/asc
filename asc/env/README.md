...
ASC provides a few example project dependencies and env models, but its purpose remains to be useful for your specific project(s). So the reason this process is detailed here is to better understand how to provide your own custom declarations.
...
. asc/stack/init.sh -s drupal-7--solr-5,redis -p ansible-2 -y
