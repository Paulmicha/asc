...
# $ . asc/provision/scripts/debian/8/vhost_create.sh
# $ . asc/provision/scripts/debian/8/vhost_create.sh the-domain.com
# $ . asc/provision/scripts/debian/8/vhost_create.sh the-domain.com www.the-domain.com
#
...
if [[ -z "${1}" ]]; then
  ...
  # echo "Example : \$ . asc/provision/scripts/debian/8/vhost_create.sh the-domain.com"
  # return
