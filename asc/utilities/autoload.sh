...
#
# Checks if its counterpart exists in asc/custom/overrides, and if it does,
...
#
# This allows to completely replace a default ASC script.
#
...
#
# Checks if its counterpart exists in asc/custom/complements, and if it does,
# source it in the scope of the calling script.
#
# This function is normally called after existing ASC generic script operations.
#
# Usage :
