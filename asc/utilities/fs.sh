...
#   most_recent="$(u_fs_get_most_recent 'asc')"
#   echo "$most_recent"
#
#   # Gets the last 3 files modified in path 'asc' :
#   most_recent="$(u_fs_get_most_recent 'asc' 3)"
#   echo "$most_recent"
#
...
# @example
#   my_file_contents=''
#   u_fs_get_file_contents 'asc/.asc_subjects_ignore' 'my_file_contents'
