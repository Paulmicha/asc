...
# ASC useful. It generates readonly global (env) vars, default Git hooks
...
u_instance_init() {
  ...
  local p_ascii_app_git_work_tree=''
  ...
  while [[ $# -gt 0 ]]; do
    case "$1" in
      ...
      -i) p_ascii_app_git_work_tree="$2"; shift 2;;
...
# which does. E.g. :
# @see asc/extensions/docker4drupal
#
