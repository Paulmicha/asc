...
- **How to mitigate**:
    - Provide [ASC self tests](https://github.com/sstephenson/bats) in `asc/test/self`
...
The general principle is : *file structure* should indicate intent. ASC's organization follows task (action), subject and/or facts, and the [semver convention](https://semver.org/).

The order or imbrication is still under study, but given ASC's minimalist ambition, it probably will remain just a principle (guideline).
