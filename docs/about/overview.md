...
The file structure follows naming conventions. Typically facts, actions, subjects are used to categorize fragments of bash scripts - or "includes" - meant to be sourced directly inside custom scripts (not included in the ASC project).
