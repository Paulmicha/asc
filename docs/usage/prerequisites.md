# Agnostic Shell Controller (ASC) documentation - Prerequisites

Once imported into your project (see [getting started](usage/getting-started.md)), this page details under which conditions ASC scripts are designed to work.
